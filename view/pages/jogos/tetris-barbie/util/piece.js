class Piece {
    ...
    moveLeft() {/*se nao colidir com algo, a peça irá se mover */
    ...
    rotate() {/*para rodar a peça e se ajustar quando trocamos ela de lugar*/
    ...
    lock() { /*trava a peça quando colidir com alguma coisa, seja, outra peça ou na parte inferior da tela do jogo*/
        for (let currentRow = 0; currentRow < this.activePiece.length; currentRow++) {
            for (let currentCol = 0; currentCol < this.activePiece.length; currentCol++) {
                if (!this.activePiece[currentRow][currentCol]) 
                  continue;
